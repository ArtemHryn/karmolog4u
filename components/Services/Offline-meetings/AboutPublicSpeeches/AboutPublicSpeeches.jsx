  ...
  return (
    <Container styled={styles.container}>
      ...
      <ul className={styles.list}>
        <li>
          <p>
            Публічні виступи – рідкісна можливість запросити мене в будь-яке
            місце (місто, країна) провести лекцію з теми на вибір для вашої
            аудиторії. У вас буде шанс зібратися разом з однодумцями та
            наставником в моєму лиці, щоб отримати шалений енергетичний заряд,
            перейняти мудрість, практичний досвід і знайти відповіді на питання,
            що хвилюють.
          </p>
        </li>
        <li>
