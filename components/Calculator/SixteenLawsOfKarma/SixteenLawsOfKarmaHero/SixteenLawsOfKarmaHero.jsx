...
const heroData = {
  ...
  desc: {
    ...
    ru: [
      ...
      'С расчетом и проработкой Матрицы "16 законами кармы" -  вы узнаете полный сценарий собственной жизни и свою кармическую историю, и как результат, получите возможность перейти в "новые вибрации Вселенной".',
