...
const heroData = {
  ...
  desc: {
    uk: [
      'Ви колись бачили як працює система у дорогих механічних годинниках? Це настільки налагоджений та ювелірна система, що він, майже як "вічний двигун", проте є одна умова — кожна з детальок має працювати, підходити сусіднім та взаємодіяти з іншими, інакше — діла не буде.',
