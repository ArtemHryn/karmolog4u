      ...
      <section className={styles.wrap}>
        ...
        <article className={styles.article}>
          <p>
            ...
            залишаєтесь на самоті. На зв'язку з вами завжди я, Сергій Скляренко,
            а також консультант Студії, щоб відповісти на всі запитання, які
            виникають у вас під час терапії.
          </p>
        </article>
      </section>
    </Container>
