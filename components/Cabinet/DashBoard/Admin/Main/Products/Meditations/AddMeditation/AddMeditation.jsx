    ...
    <FormProvider {...methods}>
      <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        <div className={styles.labels_wrapper}>
          <RequiredLabels />
          {watch('category') === ARCANES && <ArcanesPart register={register} />}
          {watch('category') === CLOSED_MEDITATIONS && (
            <ClosedPart
              register={register}
              watch={watch}
              control={control}
          ...
          {watch('category') === OPENED_MEDITATIONS && <OpenedPart register={register} />}
        </div>
