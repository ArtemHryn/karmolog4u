...
import { accessTypeList, completenessList, typesList } from '@/helper/platform/coursesList';
import { toast } from 'react-toastify';

const ModalContent = ({ course, setOpenMoreDetails }) => {
  return (
    <div className={styles.modal_wrapper}>
      <div className={styles.img_wrapper}>
        <Image width={92} height={88} src={course.cover} alt={course.name} className={styles.img} />
        <button
