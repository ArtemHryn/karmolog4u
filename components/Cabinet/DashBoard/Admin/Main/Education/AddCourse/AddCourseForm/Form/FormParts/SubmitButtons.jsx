...
const SubmitButtons = ({ setStatusAndSubmit }) => {
  return (
    <div className={styles.submit_wrapper}>
      <p className={styles.submit_title}>Для додавання уроків збережіть створений курс</p>
      <div className={styles.buttons_wrapper}>
        <button
          type="button"
          onClick={() => setStatusAndSubmit(PUBLISHED)}
          className={`${styles.submit_button} ${styles.submit_button_published} ${open_Sans.className}`}
        >
        ...
        <button
          ...
          className={`${styles.submit_button} ${styles.submit_button_draft} ${open_Sans.className}`}
        >
