...
const text = [
  "Глибинна психотерапевтична робота з розблокуванням свідомих та підсвідомих процесів для розбору запиту кожного учасника. Моя авторська методика дозволяє запустити процес синтезу деструктивної програми в свідомості кожного учасника, завдяки чому трансформація відбувається з гарантованою ефективністю.",
];

const practiceSteps = [
  "Проводиться психологічна робота з виявлення глибинних деструктивних програм, формування запиту в особистій коуч-сесії зі мною.",
