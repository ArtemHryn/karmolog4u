...
export const getGenericTables = ({ info }) => {
  const data = {
    table1: {
      columnNames: {
        uk: ['Духовний урок роду батька', 'Земний урок роду батька', 'Цілісний ключ роду батька'],
        ru: ['Духовный урок рода отца', 'Земной урок рода отца', 'Целостный ключ рода отца'],
      },
      arcanes: getFatherArcanesList(info),
    },
    table2: {
      columnNames: {
        uk: ['Духовний урок роду матері', 'Земний урок роду матері', 'Цілісний ключ роду матері'],
        ru: ['Духовный урок рода матери', 'Земной урок рода матери', 'Целостный ключ рода матери'],
      },
      arcanes: getMotherArcanesList(info),
    },
    table3: {
      columnNames: {
        uk: ['Цілісний ключ рода батька', 'Цілісний ключ рода матері', 'Ключ прими- рення'],
        ru: ['Целостный ключ рода отца', 'Целостный ключ рода матери', 'Ключ прими- рения'],
      },
    },
  };
